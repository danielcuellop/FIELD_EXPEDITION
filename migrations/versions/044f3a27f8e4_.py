...
Revision ID: 044f3a27f8e4
Revises: 6a977bbf0ffa
Create Date: 2023-07-17 00:54:54.644969
...
revision = '044f3a27f8e4'
down_revision = '6a977bbf0ffa'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('image_specimen', sa.String(length=250), nullable=False),
